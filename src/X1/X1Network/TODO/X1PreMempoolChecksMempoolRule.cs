...
namespace X1.X1Network.TODO
{
    ...
    /// </summary>
    public class X1PreMempoolChecksMempoolRule : MempoolRule
    {
        private readonly IDateTimeProvider dateTimeProvider;
        private readonly NodeSettings nodeSettings;
        private readonly CheckPowTransactionRule checkPowTransactionRule;

        public X1PreMempoolChecksMempoolRule(Network network,
        ...
        public override void CheckTransaction(MempoolValidationContext context)
        {
            ...
            // we do not need the CheckPosTransactionRule, the checks for empty outputs are already in the X1OutputNotWhitelistedMempoolRule.

            CheckStandardTransaction(context);

            // X1 behaves according to BIP 113. Since the adoption of BIP 113, the time-based nLockTime is compared to the 11 - block median time past
        ...
        private void CheckStandardTransaction(MempoolValidationContext context)
        {
            ...
            foreach (TxOut txOut in tx.Outputs)
            {
                ...
                // Output checking is already implemented in the X1OutputNotWhitelistedRule
                // and X1OutputNotWhitelistedMempoolRule.
